                ...
                <div class="col-12 col-lg-4 d-none d-lg-block">
                    <div class="most-read-container">
                        ...
                        <div class="right-sidebar-item mb-5 d-flex">
                            <img src="img/blog-item-2.png" alt="blog" class="rounded">
                    ...
                    <div class="blogs-container d-flex flex-wrap">
                        <div class="px-3 py-2 rounded-pill letter-spacing-1 fs-5 me-3 mb-4" role="button"><a
                                href="blogs.html" class="text-decoration-none text-dark">science</a></div>
                        <div class="px-3 py-2 rounded-pill letter-spacing-1 fs-5 me-3 mb-4" role="button"><a
                                href="blogs.html" class="text-decoration-none text-dark">clothing</a></div>
                        <div class="px-3 py-2 rounded-pill letter-spacing-1 fs-5 me-3 mb-4" role="button"><a
                                href="blogs.html" class="text-decoration-none text-dark">lamborghini</a></div>
                        <div class="px-3 py-2 rounded-pill letter-spacing-1 fs-5 me-3 mb-4" role="button"><a
                                href="blogs.html" class="text-decoration-none text-dark">galaxy</a></div>
                        <div class="px-3 py-2 rounded-pill letter-spacing-1 fs-5 me-3 mb-4" role="button"><a
                                href="blogs.html" class="text-decoration-none text-dark">clothing</a></div>
                        <div class="px-3 py-2 rounded-pill letter-spacing-1 fs-5 me-3 mb-4" role="button"><a
                                href="blogs.html" class="text-decoration-none text-dark">galaxy</a></div>
