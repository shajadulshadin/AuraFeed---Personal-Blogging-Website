        ...
        <div class="container text-white py-5">
            <div class="row d-flex align-items-center">
                <div class="col-12 col-lg-4">
                    <img src="assets/img/logo-footer.png" alt="Logo" class="w-100">
                ...
                <div class="col-12 col-lg-4 text-lg-center text-start mt-5">
                    ...
                    <ul class="list-unstyled fs-3 mt-5">
                        <li class="mb-3 letter-spacing-2"><a href="about.php"
                                class="text-decoration-none text-gray">About us</a>
                        </li>
                        <li class="mb-3 letter-spacing-2"><a href="contact.php"
                                class="text-decoration-none text-gray">Contact us</a>
                        </li>
                        <li class="mb-3 letter-spacing-2"><a href="policy.php"
                                class="text-decoration-none text-gray">Privacy Policy</a>
                        </li>
                        <li class="mb-3 letter-spacing-2"><a href="terms.php"
